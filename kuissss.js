...
const books = [
  ...
  const highSales = books.filter((book)=>book.sales>1000000);
  const greatAuthors = highSales.map((book) => { return `${book.author} adalah penulis buku ${book.title} yang sangat hebat!`});
